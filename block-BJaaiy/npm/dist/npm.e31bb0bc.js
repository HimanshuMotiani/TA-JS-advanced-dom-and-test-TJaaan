...
var day7 = moment().add(7, 'days').calendar();
console.log(day7);
var month7 = moment().add(7, "month").calendar();
console.log(month7);
var year7 = moment().add(7, "year").calendar();
console.log(year7);
var subDay7 = moment().subtract(7, 'days').calendar();
console.log(subDay7);
var subMonth7 = moment().subtract(7, "month").calendar();
console.log(subMonth7);
var subYear7 = moment().subtract(7, "year").calendar();
console.log(subYear7);
var dateStart = "2014-11-11";
var dateEnd = "2015-09-11";
...
var newStartDate = "2014-11-27";
var newEndDate = "2015-09-16";
var newStart = moment(newStartDate);
var newEnd = moment(newEndDate);
;
var difference = moment.duration(newEnd.diff(newStart)).asDays();
console.log(difference);
var result = moment('2020-01-01').isSameOrAfter('2018-01-01');
console.log(result);
var result1 = moment('2010-01-01').isSameOrAfter('2018-01-01');
console.log(result1);
